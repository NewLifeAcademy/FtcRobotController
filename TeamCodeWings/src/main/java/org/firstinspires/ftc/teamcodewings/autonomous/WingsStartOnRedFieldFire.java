...
@Autonomous(name = "Auto - Start on Red Field - Fire", preselectTeleOp = "B-bot original code")
@Config
public class WingsStartOnRedFieldFire extends LinearOpMode {
    ...
    public static double WAYPOINT_FIRE_X = 50;
    public static double WAYPOINT_FIRE_Y = 10;
    public static double WAYPOINT_FIRE_HEADING =242;
